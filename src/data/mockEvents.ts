...
export const mockEvents: MockEvent[] = [
  ...
  { eventId: 'evt_013', name: 'Legally Blonde \u2013 The Musical', eventDate: '2026-07-29T19:30:00', venue: { name: 'Esplanade Concert Hall', city: 'Singapore' }, pricingTiers: [{ category: 'Circle', price: 98 }, { category: 'Stalls', price: 148 }], image: 'https://picsum.photos/seed/legally-blonde-sg/800/450', type: 'theater', featured: true },
  ...
  { eventId: 'evt_002', name: "SSO Gala: Beethoven's 9th", eventDate: '2026-07-20T20:00:00', venue: { name: 'Esplanade Concert Hall', city: 'Singapore' }, pricingTiers: [{ category: 'Balcony', price: 85 }, { category: 'Front Stalls', price: 145 }], image: 'https://picsum.photos/seed/sso-beethoven/800/450', type: 'other' },
  { eventId: 'evt_008', name: 'Hans Zimmer Live', eventDate: '2026-11-21T20:00:00', venue: { name: 'Capitol Theatre', city: 'Singapore' }, pricingTiers: [{ category: 'Standard', price: 88 }, { category: 'Premium', price: 168 }], image: 'https://picsum.photos/seed/hans-zimmer/800/450', type: 'other' },
  { eventId: 'evt_014', name: 'CATS \u2013 The Musical', eventDate: '2026-11-06T19:30:00', venue: { name: 'Capitol Theatre', city: 'Singapore' }, pricingTiers: [{ category: 'Circle', price: 115 }, { category: 'Stalls', price: 178 }], image: 'https://picsum.photos/seed/cats-musical-sg/800/450', type: 'theater' },
  ...
  { eventId: 'evt_010', name: 'Mountbatten Festival of Music 2026', eventDate: '2026-09-30T19:30:00', venue: { name: 'Sands Theatre', city: 'Singapore' }, pricingTiers: [{ category: 'Standard', price: 65 }, { category: 'Premium', price: 120 }], image: 'https://picsum.photos/seed/mountbatten-2026/800/450', type: 'other' },
]
